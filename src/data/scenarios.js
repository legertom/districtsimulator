    ...
    // ── Scenario 1A: First-Time IDM Provisioning Setup ───────────
    {
        ...
        steps: [
...

            {
                ...
                guideMessage: "Click 'Next' or select 'Set login credentials' in the sidebar.",
                alexPrompt: "Now we need to set up how Clever creates email addresses and passwords for Google accounts. Click \"Next\" or select \"Set login credentials\" in the sidebar.",
                ...
                hint: {
                    ...
                    message: "Click 'Next' or select 'Set login credentials' in the sidebar.",
                },
                autoShowHint: true,
            },
            {
            ...
            },
            {
                ...
                nextStep: "step_setup_student_edit_format",
                ...
                alexCorrectResponse: "Here's the email configuration. The format is empty \u2014 we need to build it. Click \"Edit your format\" to open the visual format builder.",
                hint: { message: "Click the 'Next Step' button at the bottom." },
                autoShowHint: true,
            },
            // ── NEW: Build student email format ──────────────────
            {
                id: "step_setup_student_edit_format",
                type: "task",
                checklistLabel: "Open the email format builder",
                goalAction: "credential-edit-format-students",
                nextStep: "step_setup_student_format_save",
                guideMessage: "Click 'Edit your format' to open the format builder.",
                alexPrompt: "The format is empty \u2014 we need to build it. Click \"Edit your format\" to open the visual format builder.",
                alexCorrectResponse: "Here's the format builder. You can add SIS variables, custom text, and dots to construct the email username. Use the \"+ Add an SIS Variable\" button to add name fields.",
                hint: { target: "edit-format-link-students", message: "Click 'Edit your format' to open the format builder." },
                autoShowHint: true,
            },
            {
                id: "step_setup_student_format_save",
                type: "task",
                checklistLabel: "Build and save the email format",
                goalAction: "credential-format-saved-students",
                nextStep: "step_setup_student_add_fallback",
                guideMessage: "Add First Name and Last Name variables, then click 'Save format'.",
                alexPrompt: "Build the email format: click \"+ Add an SIS Variable\" and select \"First Name\", then add \"Last Name\" the same way. When done, click \"Save format\".",
                alexCorrectResponse: "The format now shows {{name.first}}{{name.last}} \u2014 that creates emails like rogeliowaelchi@cedarridgesd.org. Simple and consistent.",
                hint: { message: "Add First Name and Last Name using '+ Add an SIS Variable', then click 'Save format'." },
                autoShowHint: false,
            },
            {
                id: "step_setup_student_add_fallback",
                type: "task",
                checklistLabel: "Add a fallback email format",
                goalAction: "credential-fallback-added-students",
                nextStep: "step_setup_student_creds_save",
                guideMessage: "Click 'Add fallback create format' for a backup email format.",
                alexPrompt: "Good practice: add a fallback format. Click \"Add fallback create format\" \u2014 this generates first.last emails if the primary format conflicts.",
                alexCorrectResponse: "Fallback added \u2014 it uses first.last with a dot separator. If rogeliowaelchi@ is taken, Clever tries rogelio.waelchi@ instead. Smart conflict resolution.",
                hint: { target: "add-fallback-students", message: "Click 'Add fallback create format' for a backup email format." },
                autoShowHint: true,
            },
            {
                ...
                alexPrompt: "Email format and fallback are set. Click \"Save\" to confirm the student credentials.",
                alexCorrectResponse: "Student credentials saved. Now let's do the same for teachers.",
                hint: { message: "Click the 'Save' button at the bottom." },
                autoShowHint: true,
            },
            {
            ...
            },
            {
                ...
                nextStep: "step_setup_teacher_edit_format",
                guideMessage: "Click 'Next Step' to see the email format.",
                alexPrompt: "Click \"Next Step\" to see the teacher email format.",
                alexCorrectResponse: "Same as students \u2014 the format is empty and needs to be configured. Click \"Edit your format\" to build it.",
                hint: { message: "Click the 'Next Step' button." },
                autoShowHint: true,
            },
            // ── NEW: Build teacher email format ──────────────────
            {
                id: "step_setup_teacher_edit_format",
                type: "task",
                checklistLabel: "Open teacher format builder",
                goalAction: "credential-edit-format-teachers",
                nextStep: "step_setup_teacher_format_save",
                guideMessage: "Click 'Edit your format' to open the format builder.",
                alexPrompt: "Click \"Edit your format\" \u2014 same process as students.",
                alexCorrectResponse: "Format builder is open. You know the drill \u2014 add First Name and Last Name.",
                hint: { target: "edit-format-link-teachers", message: "Click 'Edit your format' to open the format builder." },
                autoShowHint: true,
            },
            {
                id: "step_setup_teacher_format_save",
                type: "task",
                checklistLabel: "Build and save teacher email format",
                goalAction: "credential-format-saved-teachers",
                nextStep: "step_setup_teacher_creds_save",
                guideMessage: "Add First Name and Last Name, then click 'Save format'.",
                alexPrompt: "Same pattern \u2014 add First Name and Last Name, then click \"Save format\". Teachers get emails like bettybauch@cedarridgesd.org.",
                alexCorrectResponse: "Teacher email format saved. Click \"Save\" to confirm the teacher credentials.",
                hint: { message: "Add First Name and Last Name, then click 'Save format'." },
                autoShowHint: false,
            },
            {
                ...
                alexPrompt: "Click \"Save\" to confirm the teacher credentials.",
                alexCorrectResponse: "Teacher credentials saved. One more \u2014 staff.",
                hint: { message: "Click the 'Save' button." },
                autoShowHint: true,
            },
            {
            ...
            },
            {
                ...
                nextStep: "step_setup_staff_edit_format",
                guideMessage: "Click 'Next Step' to see the email format.",
                alexPrompt: "Click \"Next Step\" to see the staff email format.",
                alexCorrectResponse: "Same as the others \u2014 format is empty. Click \"Edit your format\" to build it.",
                hint: { message: "Click the 'Next Step' button." },
                autoShowHint: true,
            },
            // ── NEW: Build staff email format ────────────────────
            {
                id: "step_setup_staff_edit_format",
                type: "task",
                checklistLabel: "Open staff format builder",
                goalAction: "credential-edit-format-staff",
                nextStep: "step_setup_staff_format_save",
                guideMessage: "Click 'Edit your format' to open the format builder.",
                alexPrompt: "Click \"Edit your format\" \u2014 last time, you've got this.",
                alexCorrectResponse: "Format builder open. Add First Name and Last Name one more time.",
                hint: { target: "edit-format-link-staff", message: "Click 'Edit your format' to open the format builder." },
                autoShowHint: true,
            },
            {
                id: "step_setup_staff_format_save",
                type: "task",
                checklistLabel: "Build and save staff email format",
                goalAction: "credential-format-saved-staff",
                nextStep: "step_setup_staff_creds_save",
                guideMessage: "Add First Name and Last Name, then click 'Save format'.",
                alexPrompt: "Add First Name and Last Name, then click \"Save format\". Staff get emails like oswaldopouros@cedarridgesd.org.",
                alexCorrectResponse: "Staff email format saved. All three user types now use the same consistent naming pattern. Click \"Save\" to confirm.",
                hint: { message: "Add First Name and Last Name, then click 'Save format'." },
                autoShowHint: false,
            },
            {
                ...
                alexPrompt: "Click \"Save\" to confirm the staff credentials.",
                alexCorrectResponse: "All credentials configured \u2014 students, teachers, and staff all use the same email pattern. Let me quiz you on what we just set up.",
                hint: { message: "Click the 'Save' button." },
                autoShowHint: true,
            },
            {
...

            {
                ...
                guideMessage: "Click 'Next' or select 'Organize OUs' in the sidebar.",
                alexPrompt: "Next up: Organizational Units. OUs determine where in Google's directory each user account lives. Click \"Next\" or select \"Organize OUs\" in the sidebar.",
                ...
                hint: { target: "wizard-step-ous", message: "Click 'Next' or select 'Organize OUs' in the sidebar." },
                autoShowHint: true,
            },
            {
...

            {
                ...
                guideMessage: "Click 'Next' or select 'Configure groups' in the sidebar.",
                alexPrompt: "Last configuration step: Groups. Google Groups let you manage email distribution lists and access control. Click \"Next\" or select \"Configure groups\" in the sidebar.",
                ...
                hint: { target: "wizard-step-groups", message: "Click 'Next' or select 'Configure groups' in the sidebar." },
                autoShowHint: true,
            },
            {
...

            {
                ...
                guideMessage: "Click 'Next' or select 'Summary' in the sidebar.",
                alexPrompt: "Almost done! The Summary gives you a bird's eye view of everything you just configured. Click \"Next\" or select \"Summary\" in the sidebar.",
                ...
                hint: { target: "wizard-step-summary", message: "Click 'Next' or select 'Summary' in the sidebar." },
                autoShowHint: true,
            },
            {
...

            {
                ...
                guideMessage: "Click 'Next' or select 'Preview and provision' in the sidebar.",
                alexPrompt: "Time for the moment of truth. Click \"Next\" or select \"Preview and provision\" in the sidebar to see what Clever will do with your configuration.",
                ...
                hint: { target: "wizard-step-preview", message: "Click 'Next' or select 'Preview and provision' in the sidebar." },
                autoShowHint: true,
            },
            {
    ...
    // ── Scenario 2A: Wizard Navigation ───────────────────────────
    {
        ...
        steps: [
            ...
            // ── 3. Check Google connection status ────────────────
            {
                ...
                question: "First wizard step: Connect to Google. Is it already connected for Cedar Ridge?",
                choices: [
    ...
    // ── Scenario 2B: Wizard Concepts ─────────────────────────────
    {
        ...
        steps: [
            ...
            // ── 3. Connect step purpose ──────────────────────────
            {
                ...
                question: "Step 1 is 'Connect to Google.' How would you explain what this step does to the board?",
                choices: [
            ...
            // ── 5. Management Level purpose ──────────────────────
            {
                ...
                question: "Marcus needs a plain-English explanation: what's the difference between Full and Password-Only?",
                correctAnswer: "full",
                matchMode: "includes",
            ...
            // ── 7. User types question ───────────────────────────
            {
                ...
                question: "Which user types can be provisioned? The board will want to know who's covered.",
            ...
            // ── 9. OUs purpose ───────────────────────────────────
            {
                ...
                question: "The board won't know what 'OUs' means. In plain terms, what are they used for?",
                choices: [
            ...
            // ── 11. Preview purpose ──────────────────────────────
            {
                ...
                question: "Last step. What actually happens when you click Preview and Provision? The board needs to understand this.",
                choices: [
    ...
    // ── Scenario 3A: Changing Student Email Format ────────────────
    {
        ...
        steps: [
            ...
            // ── 4. Identify the current format ───────────────────
            {
                ...
                question: "What's the current student email format? That's what we need to change.",
            ...
            // ── 5. Where to edit the format ──────────────────────
            {
                ...
                question: "Now that you can see the format — where would you go to change it?",
                choices: [
    ...
    // ── Scenario 3B: Understanding Credential Formats ──────────────
    {
        ...
        steps: [
            ...
            // ── 4. SIS variables differ by type ──────────────────
            {
                ...
                question: "Sarah wants to know: do all user types share the same SIS variables for email formats, or are they different?",
                choices: [
            ...
            // ── 5. Check shared domain ───────────────────────────
            {
                ...
                question: "What domain do all three user types share? Quick one.",
            ...
            // ── 6. Assess password formats ───────────────────────
            {
                ...
                question: "Looking at the student password — what SIS data goes into it?",
                choices: [
            ...
            // ── 8. Fallback concept ──────────────────────────────
            {
                ...
                question: "There's a 'fallback' email format option. What's that for?",
                choices: [
            ...
            // ── 9. Matching vs. creating ─────────────────────────
            {
                ...
                question: "Sarah specifically asked about matching vs. creating. What's the difference?",
                choices: [
    ...
    // ── Scenario 4A: OU Navigation ─────────────────────────────────
    {
        ...
        steps: [
            ...
            // ── 4. Understand student OU structure ──────────────────
            {
                ...
                question: "Lisa has a parent on the phone. How are students organized into Google's directory structure?",
                choices: [
            ...
            // ── 6. Teacher OU assessment ────────────────────────────
            {
                ...
                question: "What about teachers — dynamic sub-OUs or a fixed path?",
                choices: [
            ...
            // ── 7. Staff OU structure ───────────────────────────────
            {
                ...
                question: "Last one — how are staff accounts organized?",
                choices: [
    ...
    // ── Scenario 4B: OU Configuration & Policies ────────────────────
    {
        ...
        steps: [
            ...
            // ── 4. Identify archive action ──────────────────────────
            {
                ...
                question: "When someone leaves the district, what happens to their account? Check the archive action.",
            ...
            // ── 5. Archive action differences ───────────────────────
            {
                ...
                question: "Marcus will ask: what's the difference between these archive options? The board needs a clear answer.",
                choices: [
            ...
            // ── 6. Ignored user handling ─────────────────────────────
            {
                ...
                question: "What happens to ignored users? What action is set for their accounts?",
    ...
    // ── Scenario 5: Group Setup ─────────────────────────────────────
    {
        ...
        steps: [
            ...
            // ── 4. Groups vs OUs distinction ────────────────────────
            {
                ...
                question: "Principal Jones heard about 'Google Groups.' How are they different from OUs?",
                correctAnswer: "email",
                matchMode: "includes",
            ...
            // ── 5. Check current rules ──────────────────────────────
            {
                ...
                question: "How many membership rules are actually set up right now?",
            ...
            // ── 7. Managed vs manual groups ─────────────────────────
            {
                ...
                question: "Important distinction — what's the difference between IDM-managed groups and ones created manually in Google Admin?",
                choices: [
            ...
            // ── 8. What happens with 0 rules ────────────────────────
            {
                ...
                question: "So with 0 rules set up, what actually happens with groups during a sync? Is Principal Jones's email list being managed?",
                choices: [
    ...
    // ── Scenario 6A: Review & Preview ───────────────────────────────
    {
        ...
        steps: [
            ...
            // ── 2. Assess Summary step purpose ────────────────────────
            {
                ...
                question: "You're on the Summary step. What's its purpose? Sarah wants to understand each layer of the safety check.",
                choices: [
            ...
            // ── 4. Read accounts to create ────────────────────────────
            {
                ...
                question: "Sarah's first question: how many new accounts will this provisioning run create?",
            ...
            // ── 5. Matched accounts ──────────────────────────────────
            {
                ...
                question: "How many accounts were matched to existing Google accounts?",
            ...
            // ── 6. Diagnostic: matched vs created ─────────────────────
            {
                ...
                question: "Sarah will want to understand this: what's the difference between Matched and Created in the preview?",
                choices: [
            ...
            // ── 7. Sync issues ───────────────────────────────────────
            {
                ...
                question: "Any sync issues showing in the preview?",
            ...
            // ── 8. Last preview run ──────────────────────────────────
            {
                ...
                question: "When was this preview last run? Sarah's whole concern is whether the data is fresh enough to trust.",
            ...
            // ── 9. Conflicts meaning ─────────────────────────────────
            {
                ...
                question: "There's a 'Conflicts' row. What does a conflict actually mean here?",
                choices: [
    ...
    // ── Scenario 6B: End-to-End Sync Management ─────────────────────
    {
        ...
        steps: [
            ...
            // ── 2. What Connect does ─────────────────────────────────
            {
                ...
                question: "First stop in the pipeline. What does this Connect step actually handle?",
            ...
            // ── 6. Archives count ────────────────────────────────────
            {
                ...
                question: "How many accounts will be archived in this run?",
            ...
            // ── 7. What Provision does ────────────────────────────────
            {
                ...
                question: "Lisa wants to know: what actually happens when you click Provision? This is the big button.",
                choices: [
...

    {
        ...
        steps: [
            ...
            },
            {
                ...
                question: "Sarah's teachers are missing accounts. What does the latest sync entry tell you?",
                choices: [
            ...
            },
            {
                ...
                question: "Based on the event details, what's the most likely root cause?",
                choices: [
...

    {
        ...
        steps: [
            ...
            },
            {
                ...
                question: "Find Betty Bauch in the events. What's her status?",
            ...
            },
            {
                ...
                question: "Based on what you see, what's blocking Betty's account?",
                choices: [
            ...
            },
            {
                ...
                type: "resolution",
                checklistLabel: "Report findings",
                question: "What should you tell Marcus about Betty's account?",
                choices: [
...

    {
        ...
        steps: [
            ...
            },
            {
                ...
                question: "Lisa thinks things look stale. Based on these timestamps, is she right?",
                choices: [
            ...
            },
            {
                ...
                type: "resolution",
                checklistLabel: "Report findings",
                question: "What should you report back to Lisa?",
                choices: [
