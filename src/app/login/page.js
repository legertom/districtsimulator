            ...
            <div className={styles.loginCard}>
                ...
                <form onSubmit={handleSubmit} className={styles.form}>
                    <div className={styles.demoHint}>
                        Demo login: <strong>principal@example.com</strong> / <strong>password</strong>
                    </div>
                ...
                {googleEnabled ? (
                    ...
                    <div className={styles.googleDisabled}>
                        Google sign-in isn&apos;t configured for local development.
                    </div>
                )}
            </div>
        </div>
